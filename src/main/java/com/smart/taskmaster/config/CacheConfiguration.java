package com.smart.taskmaster.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.smart.taskmaster.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.smart.taskmaster.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
