    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="taskMasterApp.project.home.createOrEditLabel">
              <Translate contentKey="taskMasterApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
