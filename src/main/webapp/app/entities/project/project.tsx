    ...
    return (
      <div>
        <h2 id="project-heading">
          <Translate contentKey="taskMasterApp.project.home.title">Projects</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="taskMasterApp.project.home.createLabel">Create new Project</Translate>
          </Link>
        </h2>
